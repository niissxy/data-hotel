...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item">
    ...
    <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
      <li>
        <a href="./index.php?aksi=Components&xaksi=Jenis Kamar&yaksi=1">
          <i class="bi bi-circle"></i><span>Jenis Kamar</span>
        </a>
      </li>
      <li>
      <a href="./index.php?aksi=Components&xaksi=Reservasi&yaksi=1">
    ...
    <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
      <li>
        <a href="tables-general.html">
          <i class="bi bi-circle"></i><span>Daftar Pegunjung</span>
        </a>
      </li>
      <li>
        <a href="tables-data.html">
          <i class="bi bi-circle"></i><span>Laporan Reservasi</span>
        </a>
      </li>
      <li>
        <a href="tables-general.html">
          <i class="bi bi-circle"></i><span>Rekap Data Reservasi</span>
        </a>
      </li>
    </ul>
  </li><!-- End Tables Nav -->
